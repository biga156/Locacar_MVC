    ...
    <div class="row">
		...
		<form method="post" action="<?= hlien("locations", "filter") ?>">
            <label for='loc_type'>Filtrer par type</label>
        ...
        <div class="col">
		<form method="post" action="<?= hlien("locations", "filter") ?>">
            <label for='loc_statut'>Filtrer par statut</label>
...
<!--******************************** -->
	...
	<p><a class="btn btn-primary" href="<?= hlien("accueil", "index", "id", 0) ?>">Nouveau locations</a></p>
